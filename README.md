...
Full write-up: [From search step to output mask in a guitar tablature neural network](https://jgoliv.github.io/portfolio/machine-learning/midi-to-tablature/article.html)
